...
| Note to Notion Page ZIP | 공부노트와 슬라이드 이미지를 Notion에 함께 가져갈 때. HTML과 `assets/` 폴더 포함 |
...
- v1.2.0에는 GPU/Metal 비교가 구현되어 있지 않습니다. 나중에 acceleration을 붙일 수 있도록 처리 엔진은 분리해두었습니다.
